{{-- New Inbound Lead --- leads.create
  Preserved features: CSRF, validation errors, name/phone/email fields,
  stage select, source, service-needed, location, estimated_value,
  assigned_user_id select, notes textarea, create + cancel actions.
--}}
@extends('layouts.app')
