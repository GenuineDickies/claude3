...
<div class="max-w-3xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-900">{{ $user->name }} — Edit Compliance</h1>
    ...
    <form method="POST" action="{{ route('technician-profiles.update', $user) }}">
        ...
        <div class="bg-white rounded-lg shadow-xs p-6 mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label for="drivers_license_number" class="block text-sm font-medium text-gray-700 mb-1">Driver's License #</label>
                ...
                <div>
                    <label for="drivers_license_expiry" class="block text-sm font-medium text-gray-700 mb-1">License Expiry</label>
                ...
                <div>
                    <label for="insurance_policy_number" class="block text-sm font-medium text-gray-700 mb-1">Insurance Policy #</label>
        ...
        <div class="bg-white rounded-lg shadow-xs p-6 mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label for="background_check_date" class="block text-sm font-medium text-gray-700 mb-1">Background Check Date</label>
                ...
                <div>
                    <label for="background_check_status" class="block text-sm font-medium text-gray-700 mb-1">Background Status</label>
                ...
                <div>
                    <label for="drug_screen_date" class="block text-sm font-medium text-gray-700 mb-1">Drug Screen Date</label>
                ...
                <div>
                    <label for="drug_screen_status" class="block text-sm font-medium text-gray-700 mb-1">Drug Screen Status</label>
        ...
        {{-- Certifications --}}
        <div class="bg-white rounded-lg shadow-xs p-6 mb-6" x-data="certifications()">
            ...
            <template x-for="(cert, idx) in certs" :key="idx">
                <div class="grid grid-cols-1 sm:grid-cols-4 gap-3 mb-3 items-end">
                    <div class="sm:col-span-2">
                        <label x-show="idx === 0" class="block text-sm font-medium text-gray-700 mb-1">Name</label>
                        <input type="text" :name="'certifications[' + idx + '][name]'" x-model="cert.name"
                               class="w-full rounded-md border-gray-300 shadow-xs text-sm focus:border-blue-500 focus:ring-blue-500"
                               placeholder="e.g. CPR / First Aid">
                    </div>
                    <div>
                        <label x-show="idx === 0" class="block text-sm font-medium text-gray-700 mb-1">Issued</label>
                        <input type="date" :name="'certifications[' + idx + '][issued_date]'" x-model="cert.issued_date"
                               class="w-full rounded-md border-gray-300 shadow-xs text-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    <div class="flex gap-2">
                        <div class="flex-1">
                            <label x-show="idx === 0" class="block text-sm font-medium text-gray-700 mb-1">Expiry</label>
        ...
        <div class="bg-white rounded-lg shadow-xs p-6 mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    <label for="emergency_contact_phone" class="block text-sm font-medium text-gray-700 mb-1">Emergency Phone</label>
                ...
                <div>
                    <label for="vehicle_year" class="block text-sm font-medium text-gray-700 mb-1">Vehicle Year</label>
