{{--
  Issue Receipt — receipts.create
  Preserved features: CSRF, Alpine receiptForm, breadcrumb, customer info
  prefilled from service request, and downstream receipt form sections
  (payment, line items, notes, actions) — unchanged.
--}}
@extends('layouts.app')
...
<div class="max-w-7xl mx-auto space-y-4">
    ...
    <h1 class="text-2xl font-bold text-white">Issue Receipt</h1>
    ...
    <form method="POST" action="{{ route('receipts.store', [$serviceRequest, $invoice]) }}" class="space-y-6" x-data="receiptForm()">
        ...
        <div class="surface-1 p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    <label for="payment_method" class="block text-sm font-medium text-gray-300 mb-1">Method</label>
                ...
                <div>
                    <label for="payment_reference" class="block text-sm font-medium text-gray-300 mb-1">Reference / Transaction ID</label>
                    <input type="text" name="payment_reference" id="payment_reference"
                           value="{{ old('payment_reference') }}"
                           class="w-full rounded-md border-white/10 shadow-xs text-sm input-crystal">
                </div>
                <div>
                    <label for="payment_date" class="block text-sm font-medium text-gray-300 mb-1">Date</label>
