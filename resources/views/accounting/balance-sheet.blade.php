...
<div class="space-y-6">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="bg-green-50">
                            ...
                            <td class="px-4 py-1.5 text-sm font-mono text-right {{ $net_income >= 0 ? 'text-green-700' : 'text-red-600' }}">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <table class="min-w-full">
            <tbody>
                <tr class="border-b">
                    <td class="px-4 py-3 text-sm font-semibold text-gray-900">Total Assets</td>
                    <td class="px-4 py-3 text-sm font-mono text-right text-gray-900">${{ number_format($total_assets, 2) }}</td>
                </tr>
                <tr class="border-b">
                    <td class="px-4 py-3 text-sm font-semibold text-gray-900">Total Liabilities + Equity + Net Income</td>
                    <td class="px-4 py-3 text-sm font-mono text-right text-gray-900">${{ number_format($equity_plus_income, 2) }}</td>
                </tr>
                <tr class="{{ round($total_assets, 2) === round($equity_plus_income, 2) ? 'bg-green-50' : 'bg-red-50' }}">
