                        ...
                        @foreach ($grouped[$type] as $account)
                            <tr class="{{ $account->is_active ? '' : 'opacity-50' }}">
                                ...
                                <td class="px-4 py-2 text-sm font-medium text-white">
                                    <a href="{{ route('accounting.general-ledger', $account) }}" class="text-cyan-400 hover:text-cyan-300 hover:underline">
                                        {{ $account->name }}
                                    </a>
                                </td>
                                ...
                                <td class="px-4 py-2 text-sm font-mono text-right {{ $account->balance() < 0 ? 'text-red-400' : 'text-white' }}">
