    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div class="flex items-center step-indicator" data-step="1">
                <div id="step-circle-1" class="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-blue-600 text-white text-sm font-bold">1</div>
                <span id="step-label-1" class="hidden sm:inline ml-2 text-sm font-medium text-blue-600">Customer</span>
            </div>
            <div class="flex-1 h-0.5 mx-2 sm:mx-4 bg-gray-300" id="step-line-1"></div>
            <div class="flex items-center step-indicator" data-step="2">
                <div id="step-circle-2" class="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-300 text-gray-600 text-sm font-bold">2</div>
                <span id="step-label-2" class="hidden sm:inline ml-2 text-sm font-medium text-gray-500">Vehicle & Service</span>
            </div>
            <div class="flex-1 h-0.5 mx-2 sm:mx-4 bg-gray-300" id="step-line-2"></div>
            <div class="flex items-center step-indicator" data-step="3">
                <div id="step-circle-3" class="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-300 text-gray-600 text-sm font-bold">3</div>
    ...
    <form action="{{ route('service-requests.store') }}" method="POST" id="service-request-form" class="space-y-6">
        ...
        <div id="wizard-step-1" class="wizard-step">
            <div class="bg-gray-50 p-4 rounded-md border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" name="first_name" id="first_name" required value="{{ old('first_name') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border" placeholder="John">
                    </div>
                    <div>
                        <label for="last_name" class="block text-sm font-medium text-gray-700">Last Name <span class="text-red-500">*</span></label>
                        <input type="text" name="last_name" id="last_name" required value="{{ old('last_name') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border" placeholder="Doe">
                    </div>
                    <div>
                        <label for="phone" class="block text-sm font-medium text-gray-700">Phone Number <span class="text-red-500">*</span></label>
                        <input type="tel" name="phone" id="phone" required maxlength="14" value="{{ old('phone') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border" placeholder="(555) 123-4567">
            ...
            <div class="pt-4 flex justify-end space-x-3">
                <a href="/" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 inline-flex items-center">
                    Cancel
                </a>
        ...
        <div id="wizard-step-2" class="wizard-step hidden">
            <div class="bg-gray-50 p-4 rounded-md border border-gray-200 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <input type="text" name="vehicle_year" id="vehicle_year" required maxlength="4" value="{{ old('vehicle_year') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border" placeholder="2024">
                    </div>
                    <div>
                        <label for="vehicle_make" class="block text-sm font-medium text-gray-700">Make <span class="text-red-500">*</span></label>
                        <input type="text" name="vehicle_make" id="vehicle_make" required value="{{ old('vehicle_make') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border" placeholder="Toyota">
                    </div>
                    <div>
                        <label for="vehicle_model" class="block text-sm font-medium text-gray-700">Model <span class="text-red-500">*</span></label>
                        <input type="text" name="vehicle_model" id="vehicle_model" required value="{{ old('vehicle_model') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border" placeholder="Camry">
                    </div>
                    <div>
                        <label for="vehicle_color" class="block text-sm font-medium text-gray-700">Color</label>
                        <input type="text" name="vehicle_color" id="vehicle_color" value="{{ old('vehicle_color') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border" placeholder="Silver">
                    </div>
                </div>
            </div>
            ...
            <div class="pt-4 flex justify-between">
                <button type="button" id="btn-back-2" class="flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                ...
                <button type="button" id="btn-next-2" class="flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                    Next
                    <svg class="ml-2 w-4 h-4 mt-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
                </button>
            </div>
        ...
        <div id="wizard-step-3" class="wizard-step hidden">
            <div class="bg-gray-50 p-4 rounded-md border border-gray-200">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="notes" id="notes" maxlength="1000" value="{{ old('notes') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border" placeholder="e.g. Flat tire, driver side rear">
                    </div>
                </div>
            </div>
            ...
            <div class="pt-4 flex justify-between">
                <button type="button" id="btn-back-3" class="flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                    <svg class="mr-2 w-4 h-4 mt-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7"/></svg>
                    Back
                </button>
                <button type="submit" class="flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors">
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="button" id="btn-same-customer" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">
                    Yes, Same Customer
                </button>
