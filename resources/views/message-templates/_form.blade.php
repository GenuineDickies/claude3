...
<div class="space-y-6">
    ...
    {{-- Template Body --}}
    <div>
        <label for="body" class="block text-sm font-medium text-gray-700 mb-1">Message Body <span class="text-red-500">*</span></label>
        ...
        <div class="flex items-center justify-between mt-1">
            <p class="text-xs text-gray-500">Use <code class="bg-gray-100 px-1 rounded-sm">@{{ variable_name }}</code> for dynamic content. Max 1600 chars.</p>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2">
            @foreach($availableVariables as $key => $def)
                <button type="button"
                        ...
                        class="text-left p-2 bg-gray-50 hover:bg-blue-50 rounded-sm border border-gray-200 hover:border-blue-300 transition-colors group">
                    <code class="text-xs text-blue-700 font-mono block group-hover:text-blue-800">@{{ {{ e($key) }} }}</code>
