...
@section('content')
<div class="max-w-4xl mx-auto space-y-6" x-data="estimateForm()">
    ...
    <div class="flex items-center gap-2 text-sm text-gray-500">
        ...
        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
        <span class="text-gray-700 font-medium">Create Estimate</span>
    </div>
    ...
    <div class="bg-linear-to-r from-blue-50 to-white rounded-lg shadow-sm p-6 border-l-4 border-blue-500">
        <div class="flex justify-between items-start">
            ...
            <span class="px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wide bg-slate-100 text-slate-600">Draft</span>
        </div>
    </div>
    ...
    <form action="{{ route('estimates.store', $serviceRequest) }}" method="POST" @submit="prepareSubmit">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            <div class="flex items-center justify-between mb-3">
                ...
                @if($stateAutoDetected)
                    <span class="inline-flex items-center gap-1 text-xs text-green-700 bg-green-50 border border-green-200 rounded-full px-2.5 py-1">
                        <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>
                        Auto-detected from service location
                    </span>
                @endif
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            ...
            <textarea id="notes" name="notes" rows="3" placeholder="Optional notes for this estimate..."
                      class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"></textarea>
        </div>
