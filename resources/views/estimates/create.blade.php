...
<div class="max-w-4xl mx-auto space-y-6" x-data="estimateForm()">
    ...
    <div class="bg-linear-to-r from-blue-50 to-white rounded-lg shadow-sm p-6 border-l-4 border-blue-500">
        <div class="flex justify-between items-start">
            <div>
                <h1 class="text-2xl font-bold text-white">Create Estimate</h1>
    ...
    <form action="{{ route('estimates.store', $serviceRequest) }}" method="POST" @submit="prepareSubmit">
        ...
        <div class="surface-1 p-6 border border-white/10">
            <div class="flex items-center justify-between mb-3">
                <h2 class="text-lg font-semibold text-white">Tax Configuration</h2>
                @if($stateAutoDetected)
                    <span class="inline-flex items-center gap-1 text-xs text-green-700 bg-green-500/10 border border-green-500/30 rounded-full px-2.5 py-1">
