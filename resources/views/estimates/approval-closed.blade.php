...
<div class="max-w-lg mx-auto">
    <div class="bg-white rounded-lg shadow-xs p-6 text-center">
        @if($estimate->status === 'accepted')
            ...
            <h1 class="text-xl font-bold text-gray-900 mb-2">Estimate Already Approved</h1>
            <p class="text-sm text-gray-600">This estimate was approved on {{ $estimate->approved_at?->format('M j, Y g:i A') }}.</p>
        @elseif($estimate->status === 'declined')
            ...
            <p class="text-sm text-gray-600">This estimate was declined on {{ $estimate->approved_at?->format('M j, Y g:i A') }}.</p>
        @else
            ...
            <p class="text-sm text-gray-600">This approval link has expired. Please contact the service provider for a new one.</p>
        @endif
    </div>
</div>
@endsection
