{{--
  New Vendor Document — vendor-documents.create
  Preserved features: CSRF, Alpine vendorDocForm, breadcrumb, vendor select
  (with $preselectedVendor), document info (type/dates/amounts/upload),
...
<div class="max-w-7xl mx-auto space-y-4">
    ...
    <h1 class="text-2xl font-bold text-white">New Vendor Document</h1>
    ...
    <form method="POST" action="{{ route('vendor-documents.store') }}" class="space-y-6" x-data="vendorDocForm()">
        ...
        <div class="surface-1 p-6">
            ...
            <textarea name="notes" id="notes" rows="3"
                      class="w-full rounded-md border-white/10 shadow-xs text-sm input-crystal">{{ old('notes') }}</textarea>
        </div>
