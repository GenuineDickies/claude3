...
<div class="max-w-lg mx-auto bg-white rounded-lg shadow-sm p-6">
    ...
    <form method="POST" action="/test-location" class="space-y-4">
        ...
        <div class="flex items-center gap-2">
            <input type="checkbox" name="force_consent" id="force_consent" value="1" class="rounded-sm border-gray-300">
            <label for="force_consent" class="text-sm text-gray-600">Skip consent check (grant consent automatically for testing)</label>
        </div>
        <button type="submit"
