...
<nav class="bg-white rounded-lg shadow-sm border border-gray-200 px-1.5 py-1.5 flex items-center gap-1 text-sm">
    <a href="{{ route('inbox.index') }}"
       class="flex items-center gap-1.5 px-3 py-1.5 rounded-md font-medium transition-colors
              {{ request()->routeIs('inbox.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50' }}">
    ...
    <a href="{{ route('transaction-imports.index') }}"
       class="flex items-center gap-1.5 px-3 py-1.5 rounded-md font-medium transition-colors
              {{ request()->routeIs('transaction-imports.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50' }}">
    ...
    <a href="{{ route('accounting.import-accounts') }}"
       class="flex items-center gap-1.5 px-3 py-1.5 rounded-md font-medium transition-colors
              {{ request()->routeIs('accounting.import-accounts') ? 'bg-blue-50 text-blue-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50' }}">
    ...
    @if (isset($breadcrumb))
        ...
        <span class="text-gray-700 font-medium truncate">{{ $breadcrumb }}</span>
    @endif
</nav>
