...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div class="bg-white rounded-lg shadow p-4">
            ...
            <p class="text-2xl font-bold text-green-600 mt-1">{{ number_format($completedRequests) }}</p>
        </div>
        <div class="bg-white rounded-lg shadow p-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-sm font-semibold text-gray-700 mb-4">Requests Over Time</h2>
            <div class="relative" style="height: 280px;">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-sm font-semibold text-gray-700 mb-4">Top Service Types</h2>
            <div class="relative" style="height: 280px;">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-sm font-semibold text-gray-700">Expenses by Category</h2>
            <p class="text-sm text-gray-500">Total: <span class="font-semibold text-gray-700">${{ number_format($totalExpenses, 2) }}</span></p>
        </div>
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
            @foreach ($expensesByCategory as $cat)
                <div class="border border-gray-200 rounded-md p-3 text-center">
                    ...
                    <p class="text-lg font-semibold text-gray-800 mt-1">${{ number_format($cat['total'], 2) }}</p>
                </div>
            @endforeach
        </div>
    </div>
