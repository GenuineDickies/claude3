...
<div class="max-w-6xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Manage categories, parts, and services for estimates.</p>
        </div>
    ...
    @if($categories->isEmpty())
        <div class="bg-white rounded-lg shadow-xs p-8 text-center">
            <p class="text-gray-500">No catalog categories yet. Create one to get started.</p>
        </div>
    @else
                ...
                <div class="bg-white rounded-lg shadow-xs p-5 flex flex-col">
                    <div class="flex items-start justify-between mb-2">
                        <div>
                            ...
                            <span @class([
                                'inline-block ml-2 px-2 py-0.5 text-xs font-medium rounded-full',
                    ...
                    <div class="mt-auto flex items-center justify-between pt-3 border-t border-gray-100">
                        <span class="text-sm text-gray-500">{{ $category->items_count }} {{ Str::plural('item', $category->items_count) }}</span>
