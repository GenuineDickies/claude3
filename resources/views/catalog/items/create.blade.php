{{--
  Add Catalog Item — catalog.items.create
  Preserved features: CSRF, shared @include('catalog.items._form'),
...
<div class="max-w-7xl mx-auto">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-white mt-2">Add Catalog Item</h1>
    </div>
