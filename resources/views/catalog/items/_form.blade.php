...
<div class="space-y-6">
    ...
    <div class="border-t pt-6">
        <h3 class="text-sm font-semibold text-gray-700 mb-4">Accounting</h3>
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                <label for="revenue_account_id" class="block text-sm font-medium text-gray-700 mb-1">Revenue Account</label>
                ...
                @error('revenue_account_id') <p class="text-red-600 text-xs mt-1">{{ $message }}</p> @enderror
            </div>
            <div>
                <label for="cogs_account_id" class="block text-sm font-medium text-gray-700 mb-1">COGS / Expense Account</label>
                ...
                @error('cogs_account_id') <p class="text-red-600 text-xs mt-1">{{ $message }}</p> @enderror
            </div>
            <div>
                <label for="core_amount" class="block text-sm font-medium text-gray-700 mb-1">Core Deposit Amount</label>
                <div class="relative">
                    <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm">$</span>
                ...
                @error('core_amount') <p class="text-red-600 text-xs mt-1">{{ $message }}</p> @enderror
            </div>
            <div class="flex items-end gap-6 pb-1">
                <label class="flex items-center gap-2 cursor-pointer">
                    ...
                    <span class="text-sm text-gray-700">Core Required</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer">
