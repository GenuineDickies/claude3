...
<div class="max-w-7xl mx-auto space-y-4">
    ...
    <h1 class="text-2xl font-bold text-white">Record Expense</h1>
    ...
    <form method="POST" action="{{ route('expenses.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="vendor" id="vendor" value="{{ old('vendor') }}"
                           placeholder="e.g. AutoZone, Shell, Home Depot"
                           class="w-full rounded-md border-white/10 shadow-xs text-sm input-crystal" required>
        ...
        <div class="surface-1 p-6">
            ...
            <div>
                <label for="receipt" class="block text-xs font-medium text-gray-500 mb-1">Upload receipt image or PDF (max 10 MB)</label>
