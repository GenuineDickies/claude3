{{--
  Edit Expense — expenses.edit
  Preserved features: CSRF, @method('PUT'), multipart upload, breadcrumb,
  expense details, payment, current receipt download link, replacement
  receipt upload, notes, update + cancel actions.
--}}
@extends('layouts.app')
