...
<div class="bg-white rounded-lg shadow-sm p-6">
    <h2 class="text-lg font-semibold text-gray-700 mb-4">Accounting</h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
        ...
        <div>
            <label for="default_expense_account_id" class="block text-sm font-medium text-gray-700 mb-1">Default Expense Account</label>
...
<div class="bg-white rounded-lg shadow-sm p-6">
    ...
    <textarea name="notes" id="notes" rows="3"
              class="w-full rounded-md border-gray-300 shadow-xs text-sm focus:border-blue-500 focus:ring-blue-500">{{ old('notes', $vendor?->notes) }}</textarea>
