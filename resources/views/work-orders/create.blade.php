...
<div class="max-w-4xl mx-auto space-y-6" x-data="workOrderForm()">
    ...
    <div class="flex items-center gap-2 text-sm text-gray-500">
        ...
        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
        <span class="text-gray-700 font-medium">Create Work Order</span>
    </div>
    ...
    <form action="{{ route('work-orders.store', $serviceRequest) }}" method="POST" @submit="prepareSubmit">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200 space-y-4">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="2" placeholder="Description of work to be performed..."
                          class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('description') }}</textarea>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200 mt-6">
            ...
            <textarea id="notes" name="notes" rows="3" placeholder="Optional notes for this work order..."
                      class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('notes') }}</textarea>
        </div>
